...
function AppStyles() {
  return <style>{`
    ...
    .chat-tab:hover{padding-right:13px;border-color:var(--cyan);}
    ...
    .cmp-chip.on{color:var(--ink);border-color:var(--c);background:color-mix(in oklch,var(--c) 14%,transparent);}
    .cmp-chip.on .cmp-dot{opacity:1;}
